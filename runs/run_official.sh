...
export NCCL_TIMEOUT=72000000 # 20小时超时（秒）
export DIST_TIMEOUT=72000000 # PyTorch分布式超时时间（秒）
# NCCL 优化环境变量
...
# 设置PyTorch默认超时（毫秒）- 注意：PyTorch期望的是毫秒，不是秒！
export TORCH_DISTRIBUTED_DEFAULT_TIMEOUT=72000000  # 72000秒 = 72000000毫秒
