...
# Specify the pretrained pth - 使用wkdrs3中的Stage 1权重
# 使用最新的检查点，或者可以指定具体的iter_*.pth/pytorch_model.bin
s1_pretrained_pth = "/mnt_llm_A100_V1/shui/LAE/X-SAM/X-SAM/wkdrs3/s1_seg_finetune/xsam_sota_s1_finetune/iter_66000.pth/pytorch_model.bin"

# Data - 使用SkyScript数据集
# JSON文件路径
data_path = "/mnt_llm_A100_V1/datasets/Image-Captioning-Dataset/SkyScript/llava_format/skyscript_stratified_50pct.json"
# 图像文件夹路径
image_folder = "/mnt_llm_A100_V1/datasets/Image-Captioning-Dataset/SkyScript/images"
...
llava_imgconv_dataset = dict(
    ...
    task_name="imgconv",
    data_name="skyscript_imgconv",  # 修改数据集名称
