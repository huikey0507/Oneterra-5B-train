...
QUESTION_LIST = [
    f"Could you please give me a brief description of the image? Please respond with interleaved segmentation masks for the corresponding parts of the answer. {DEFAULT_SEG_TOKEN}",
    f"Can you provide a brief description of the this image? Please output interleaved segmentation masks for the corresponding phrases. {DEFAULT_SEG_TOKEN}",
    f"Please briefly describe the contents of the image. Please respond with interleaved segmentation masks for the corresponding parts of the answer. {DEFAULT_SEG_TOKEN}",
    f"Could you give a brief explanation of what can be found within this picture? Please output interleaved segmentation masks for the corresponding phrases. {DEFAULT_SEG_TOKEN}",
    f"Could you give me an brief explanation of this picture? Please respond with interleaved segmentation masks for the corresponding phrases. {DEFAULT_SEG_TOKEN}",
    f"Could you provide me with a briefly analysis of this photo? Please output interleaved segmentation masks for the corresponding parts of the answer. {DEFAULT_SEG_TOKEN}",
]
...
def gcg_seg_conversations(caption, tokens_positive, question=None, output_ids_with_output=True, cond_type="phrase"):
    ...
    if output_ids_with_output and tokens_positive is not None:
        answer = tag_caption(caption, tokens_positive, phrase_format).strip() + " " + random.choice(ANSWER_LIST).strip()
    else:
        answer = ""
