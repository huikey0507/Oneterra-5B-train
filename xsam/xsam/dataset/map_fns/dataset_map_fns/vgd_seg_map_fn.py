...
QUESTION_LIST = [
    f"Can you segment the image based on the following regions: {{regions}}? Please output the corresponding segmentation mask. {DEFAULT_SEG_TOKEN}",
    f"Can you generate segmentation masks for this image based on the specified regions: {{regions}}? Please generate the segmentation masks. {DEFAULT_SEG_TOKEN}",
    f"Can you provide segmentation masks for this image based on these regions: {{regions}}? Please provide the segmentation masks. {DEFAULT_SEG_TOKEN}",
    f"Could you create segmentation masks for this image according to the specified regions: {{regions}}? Please create the segmentation masks. {DEFAULT_SEG_TOKEN}",
    f"Could you output segmentation masks for this image that highlight the following regions: {{regions}}? Please output the segmentation masks. {DEFAULT_SEG_TOKEN}",
    f"Could you provide segmentation masks for this image according to the specified regions: {{regions}}? Please respond with the segmentation masks. {DEFAULT_SEG_TOKEN}",
]
